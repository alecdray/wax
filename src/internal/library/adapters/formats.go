...
func (h *HttpHandler) GetDiscogsRelease(w http.ResponseWriter, r *http.Request) {
	...
	// Prefer the most precise date available from the Release object, falling back
	// to the bare year forwarded from the search result. Always returns YYYY-MM-DD.
