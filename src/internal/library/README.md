...
`library` also owns the **album view UI** — every user-facing surface that centres on albums, including the dashboard, album-detail page, the discover flow, and the modals that mutate album state.
