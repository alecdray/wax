...
| Doc | What | When |
|---|---|---|
| [genres](../../../docs/product/genres.md) | curated, auto-assigned genre badges on albums | deciding which genres count as primaries or how the DAG maps to user-visible genres |
