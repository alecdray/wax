...
|---|---|---|
| high | **Crates** *(in progress)* | Named, unordered collections — "jazz," "road trip music," "gifts for friends." Membership is the point, not position. Distinct from tags: crates are first-class objects with their own pages; tags are lightweight inline labels. Spec: `docs/spec/1785103459-album-groups/`. |
